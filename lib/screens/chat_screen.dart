    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Nome: ${authProvider.user?.displayName ?? 'Não informado'}'),
            const SizedBox(height: 8),
            Text('Email: ${authProvider.user?.email ?? ''}'),
            const SizedBox(height: 8),
            Text('Membro desde: ${authProvider.userModel?.createdAt.day}/${authProvider.userModel?.createdAt.month}/${authProvider.userModel?.createdAt.year}'),
          ],
        ),
        actions: [
          TextButton(
